...
const EditActivityStatus = ({ params }) => {
  const { id } = params;
  ...
  const getStatus = async () => {
    const res = await fetch(`${baseUrl}/api/activity-status/${id}/edit`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const res = await fetch(`${baseUrl}/api/activity-status/${id}`, {
      method: "PUT",
      headers: {
  ...
  return (
    <Fragment>
      <Seo title={"Edit Activity Status"} />
      <Pageheader
        currentpage="Edit Activity Status"
        activepage="Activity Statuses"
        activeurl="/referential/activity-status"
        mainpage="Edit Activity Status"
      />
              ...
              >
                <div className="xl:col-span-6 col-span-12">
                  ...
                  <input
                    ...
                    id="input-label"
                    placeholder="Enter Activity Status Title"
                    name="title"
                    required
