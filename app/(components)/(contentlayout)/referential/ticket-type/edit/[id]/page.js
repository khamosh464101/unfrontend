...
const EditTicketType = ({ params }) => {
  ...
  const getType = async () => {
    const res = await fetch(`${baseUrl}/api/ticket-type/${id}/edit`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const res = await fetch(`${baseUrl}/api/ticket-type/${id}`, {
      method: "PUT",
      headers: {
