...
const CreateStaffStatus = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const res = await fetch(`${apiUrl}/api/staffs-status`, {
      method: "POST",
      headers: {
  ...
  return (
    <Fragment>
      <Seo title={"Create  Staff Status"} />
      <Pageheader
        currentpage="Create  Staff Status"
        activepage=" Staff Statuses"
        activeurl="/referential/staf-status"
        mainpage="Create  Staff Status"
      />
...
export default CreateStaffStatus;
