...
const EditProjectStatus = ({ params }) => {
  const { id } = params;
  ...
  const getStatus = async () => {
    const res = await fetch(`${apiUrl}/api/projects-status/${id}/edit`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const res = await fetch(`${apiUrl}/api/projects-status/${id}`, {
      method: "PUT",
      headers: {
  ...
  return (
    <Fragment>
      <Seo title={"Edit Project Status"} />
      <Pageheader
        currentpage="Edit Project Status"
        activepage="Project Statuses"
        activeurl="/referential/project-status"
        mainpage="Edit Project Status"
      />
              ...
              >
                <div className="xl:col-span-6 col-span-12">
                  ...
                  <input
                    ...
                    id="input-label"
                    placeholder="Enter Project Status Title"
                    name="title"
                    required
