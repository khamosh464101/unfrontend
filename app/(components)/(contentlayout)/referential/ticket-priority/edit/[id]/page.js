...
const EditTicketPriority = ({ params }) => {
  const { id } = params;
  ...
  const getPriority = async () => {
    const res = await fetch(`${baseUrl}/api/ticket-priority/${id}/edit`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const res = await fetch(`${baseUrl}/api/ticket-priority/${id}`, {
      method: "PUT",
      headers: {
  ...
  return (
    <Fragment>
      <Seo title={"Edit Ticket Priority"} />
      <Pageheader
              ...
              >
                <div className="xl:col-span-6 col-span-12">
                  ...
                  <input
                    ...
                    id="input-label"
                    placeholder="Enter Ticket Priority Title"
                    name="title"
                    required
                ...
                <div className="xl:col-span-4 col-span-12 form-check">
                  ...
                  <p>
                    If checked, this priority will be automatically afffected to
                    new ticket
                  </p>
                </div>
              </form>
...
export default EditTicketPriority;
