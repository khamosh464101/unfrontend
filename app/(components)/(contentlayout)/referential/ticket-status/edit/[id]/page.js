...
const EditTicketStatus = ({ params }) => {
  ...
  const getStatus = async () => {
    const res = await fetch(`${baseUrl}/api/ticket-status/${id}/edit`, {
      method: "GET",
      headers: {
              ...
              >
                <div className="xl:col-span-6 col-span-12">
                  ...
                  <input
                    ...
                    id="input-label"
                    placeholder="Enter Ticket Status Title"
                    name="title"
                    required
