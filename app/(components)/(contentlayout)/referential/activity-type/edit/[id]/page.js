...
const EditActivityType = ({ params }) => {
  ...
  const getType = async () => {
    const res = await fetch(`${baseUrl}/api/activity-type/${id}/edit`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const res = await fetch(`${baseUrl}/api/activity-type/${id}`, {
      method: "PUT",
      headers: {
              ...
              >
                <div className="xl:col-span-6 col-span-12">
                  ...
                  <input
                    ...
                    id="input-label"
                    placeholder="Enter Activity Type Title"
                    name="title"
                    required
