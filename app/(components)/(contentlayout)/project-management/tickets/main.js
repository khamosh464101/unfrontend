                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-pinkmain/10 text-pinkmain">
                            Admin
                          </span>
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-tealmain/10 text-tealmain">
                            Product
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-purplemain/10 text-purplemain">
                            Review
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
