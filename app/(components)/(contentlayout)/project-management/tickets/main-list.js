                    ...
                    <tr className="border border-defaultborder task-list">
                      ...
                      <td>
                        <div className="hs-tooltip ti-main-tooltip">
                          <button
                            type="button"
                            className="hs-tooltip-toggle ti-btn me-2 ti-btn-primary ti-btn-sm"
                          >
                            <i className="ri-edit-line"></i>
                            <span
                              className="hs-tooltip-content  ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm "
            ...
            <div className="box-body !p-0">
              <div className="!p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start">
                ...
                <div className="flex-grow">
                  <h6 className="!mb-1 !text-[0.75rem] !font-medium">
                    New Tasks
              ...
              <div className="p-6 pb-2">
                ...
                <div id="task-list-stats">
                  <ReactApexChart
                    options={Listdata.TransactionsStatistics.options}
                    series={Listdata.TransactionsStatistics.series}
                    type="bar"
                    width={"100%"}
                    height={210}
                  />
