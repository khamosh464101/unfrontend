...
const Header = ({ local_varaiable, ThemeChanger }) => {
  ...
  //         if (html.getAttribute('data-toggled') === '' ) {
                  ...
                  <ul className="text-defaulttextcolor font-medium dark:text-[#8c9097] dark:text-white/50">
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ti ti-user-circle text-[1.125rem] me-2 opacity-[0.7] !inline-flex"></i>
                        Profile
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ti ti-inbox text-[1.125rem] me-2 opacity-[0.7] !inline-flex"></i>
                        Inbox{" "}
                    ...
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ti ti-clipboard-check text-[1.125rem] me-2 opacity-[0.7] !inline-flex"></i>
                        Task Manager
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link
                        ...
                        scroll={false}
                      >
                        <i className="ti ti-wallet text-[1.125rem] me-2 opacity-[0.7 !inline-flex"></i>
                        Bal: $7,12,950
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ti ti-headset text-[1.125rem] me-2 opacity-[0.7] !inline-flex"></i>
                        Support
                      </Link>
                    </li>
                    {session?.user && (
                      <li>
                        <button
                          className="w-full ti-dropdown-item !text-[0.8125rem] !p-[0.65rem] !gap-x-0 !inline-flex text-start"
