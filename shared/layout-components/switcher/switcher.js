					...
					<div
						...
						<div>
							...
							<div className="px-4 text-secondary text-xs">
								<b className="me-2">Note:</b>Works same for both Vertical and Horizontal
							</div>
						</div>
						<div className=" sidemenu-layout-styles">
							...
							<div className="px-4 text-secondary text-xs">
								<b className="me-2">Note:</b>Navigation menu styles won't work here.
							</div>
						</div>
						<div>
					...
					>
						<div className="theme-colors">
							...
							<div className="px-4 text-[#8c9097] dark:text-white/50 text-[.6875rem]">
								<b className="me-2">Note:</b>If you want to change color Menu dynamically change from below Theme Primary color picker.
							</div>
						</div>
						<div className="theme-colors">
							...
							<div className="flex flex-wrap switcher-style gap-y-2 gap-x-5 rtl:gap-x-reverse">
								...
								<div className="ti-form-radio switch-select">
									<input
										...
										type="radio"
										name="theme-background"
										checked={local_varaiable.darkBg == "22 92 129"}
										onChange={(_e) => {}}
